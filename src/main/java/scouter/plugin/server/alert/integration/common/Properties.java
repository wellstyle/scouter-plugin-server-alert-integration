...
public class Properties {
    ...
    public static final String EXT_PLUGIN_ALERT_SLACK_DEBUG = "ext_plugin_alert_slack_debug";
    ...
    public static final String EXT_PLUGIN_ALERT_TELEGRAM_DEBUG = "ext_plugin_alert_telegram_debug";
